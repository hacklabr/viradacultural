    ...
    <!-- --------------------------------- -->
        ...
        <div class="row">
            <section id="main-section" class="panel-group col-md-11 col-md-offset-1">
                ...
                <div class="panel panel-default hl-carrousel" ng-show="viewBy === 'space' && viewMode === 'grid'" ng-repeat="space in searchResult" ng-show="!filters.spaces || (filters.spaces && space.isSelected())">
                    <div class='hl-ref'></div>
                ...
                <div ng-if="viewBy === 'name'">
                    <article class="event clearfix" ng-repeat="eventrepeat in eventIndexByName" ng-class="{'event-grid': viewMode === 'grid', 'event-list': viewMode === 'list'}">
                        <img ng-src="{{conf.baseURL}}/wp-content/uploads/2014/03/Virada-Cultural-2013_racionais-foto_sylvia_masini-18-320x210.jpg"/>
                        <div class="event-content clearfix">
