                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="share-buttons">
                        <ul class="rrssb-buttons clearfix">
                            <li class="email">
                                <a href="mailto:?subject=Virada%20Cultural&amp;body=<?php the_permalink(); ?>">
                                    <span class="icon">
                            ...
                            <li class="facebook">
                                <a href="https://www.facebook.com/sharer/sharer.php?u=http://viradacultural.sp.gov.br/<?php /*the_permalink();*/ ?>" class="popup">
                                    <span class="icon">
                            ...
                            <li class="twitter">
                                <a href="http://twitter.com/home?status=http://viradacultural.sp.gov.br/<?php /*the_permalink();*/ ?>" class="popup">
                                    <span class="icon">
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                            ...
                            <li class="googleplus">
                                <a href="https://plus.google.com/share?url=http://viradacultural.sp.gov.br/<?php /*the_permalink();*/ ?>" class="popup">
                                    <span class="icon">
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                                            <g>
                                                <g>
